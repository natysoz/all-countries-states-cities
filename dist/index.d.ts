import { Country, GetBasicCountriesResponse, GetCitiesByCountryResponse, GetCitiesParams, GetStatesByCountryResponse, GetStatesParams, PaginationParams } from './types/index.js';
/**
 ...
 */
declare function getCountries({ page, limit, skip, project }?: PaginationParams): GetBasicCountriesResponse;
/**
 ...
 */
declare function getCountry(isoCode: string): Country;
/**
 ...
 */
declare function getStates({ isoCode, page, limit, skip, project }: GetStatesParams): Promise<GetStatesByCountryResponse>;
/**
 ...
 */
declare function getCities({ isoCode, state, page, limit, skip, project }: GetCitiesParams): Promise<GetCitiesByCountryResponse>;
